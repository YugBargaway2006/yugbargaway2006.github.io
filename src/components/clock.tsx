...
export function IITKGPClock() {
    ...
    return (
        <a
            ...
            className="flex items-center gap-2 text-sm font-mono text-muted-foreground bg-secondary/30 px-3 py-1 rounded-full border border-border backdrop-blur-sm hover:text-primary hover:border-primary/50 transition-colors"
        >
