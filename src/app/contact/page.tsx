...
export default function ContactPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            // Use environment variable if available, otherwise use hardcoded key for production
            const WEB3FORMS_KEY = process.env.NEXT_PUBLIC_WEB3FORMS_KEY || "b8c28458-034f-432b-b210-8a7ad470edaa";
